...
typedef enum _usb_device_bootloader_event
{
    kUSB_DeviceBootloaderEventSendResponse = 0x01U, /*!< Send data completed or cancelled etc*/
    kUSB_DeviceBootloaderEventRecvResponse,         /*!< Data received or cancelled etc*/
    kUSB_DeviceBootloaderEventRecvBulkResponse,
    kUSB_DeviceBootloaderEventSetProtocol,          /*!< Set protocol request */
} usb_device_bootloader_event_t;

/* class header for hobart pritner */
typedef struct _usb_device_bootloader
{
 ...
 */
extern usb_status_t USB_DeviceHBBootloaderInit(uint8_t controllerId,
 ...
 * @return A USB error code or kStatus_USB_Success.
 */
extern usb_status_t USB_DeviceHBBootloaderDeinit(class_handle_t handle);
 ...
 */
extern usb_status_t USB_DeviceHBBootloaderEvent(void *handle, uint32_t event, void *param);
 ...
 * callback).
 */
extern usb_status_t USB_DeviceHBBootloaderSend(class_handle_t handle, uint8_t ep, uint8_t *buffer, uint32_t length);
 ...
 * callback).
 */
extern usb_status_t USB_DeviceHBBootloaderRecv(class_handle_t handle, uint8_t ep, uint8_t *buffer, uint32_t length);
