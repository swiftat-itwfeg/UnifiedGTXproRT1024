...
#if ((defined(USB_DEVICE_CONFIG_HOBART)) && (USB_DEVICE_CONFIG_HOBART > 0U))
...
static const usb_device_class_map_t s_UsbDeviceClassInterfaceMap[] = {
...
#if ((defined USB_DEVICE_CONFIG_PRINTER) && (USB_DEVICE_CONFIG_PRINTER > 0U))
    {USB_DeviceBootloaderInit, USB_DeviceBootloaderDeinit, USB_DeviceBootloaderEvent, kUSB_DeviceClassTypeBootloader},
#endif
    ...
    {USB_DeviceHBBootloaderInit, USB_DeviceHBBootloaderDeinit, USB_DeviceHBBootloaderEvent, kUSB_DeviceClassTypeBHobart},
#endif  
...
)
{
    ...
    for (classIndex = 0U; classIndex < classHandle->configList->count; classIndex++)
    {
             ...
             mapIndex++)
        {
            ...
            {
				if(s_UsbDeviceClassInterfaceMap[mapIndex].classInit != NULL)
				{
