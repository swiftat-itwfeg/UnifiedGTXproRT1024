...
/*! @brief Bootloader instance count */
#define USB_DEVICE_CONFIG_BOOTLOADER (0U)

/*! @brief Hobart Bootloader instance count */
#define USB_DEVICE_CONFIG_HOBART_BOOTLOADER (1U)
