...
static const usb_device_class_map_t s_UsbDeviceClassInterfaceMap[] = {
    ...
    {USB_DeviceHBPrinterInit, USB_DeviceHBPrinterDeinit, USB_DeviceHBPrinterEvent, kUSB_DeviceClassTypePHobart},
#endif
#if ((defined USB_DEVICE_CONFIG_HOBART_WEIGHER) && (USB_DEVICE_CONFIG_HOBART_WEIGHER > 0U))   
    {USB_DeviceHBWeigherInit, USB_DeviceHBWeigherDeinit, USB_DeviceHBWeigherEvent, kUSB_DeviceClassTypeWHobart},
#endif    
