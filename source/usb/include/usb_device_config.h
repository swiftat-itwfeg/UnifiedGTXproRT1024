...
/*! @brief Hobart printer instance count */
#define USB_DEVICE_CONFIG_HOBART_PRINTER (1U)
      
/*! @brief Hobart weigher instance count */
#define USB_DEVICE_CONFIG_HOBART_WEIGHER (1U)

/*! @brief Hobart instance count */
#define USB_DEVICE_CONFIG_HOBART (1U)        
