#ifndef HOBARTPRINTERTASK_H
#define HOBARTPRINTERTASK_H
#include "FreeRTOS.h"
#include "task.h"
#include "queue.h"
#include "timers.h"
...
/* prototypes */
BaseType_t createHobartPrinterTask( PrinterStyle style, QueueHandle_t msgQueue );
...
bool getlastLabelInPrintJob( void );
