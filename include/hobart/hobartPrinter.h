#ifndef HOBARTPRINTER_H
#define HOBARTPRINTER_H
...
typedef struct pr_configuration 
{
    ...
    unsigned char       shootThroughCal;                /* media or shoot sensor cal value  */                     
    ...
    unsigned char       backingAndlabel;                /* shoot through backing paper and label counts */
    unsigned char       labelCalCnts;                   /* label taken label present cal counts */
    unsigned char       noLabelCalCnts;                 /* no label present cal counts */
    bool                cutterEnabled;
    unsigned char       takeupDriveCurrent;		/* takeup sensor drive current cal value  */                     
    unsigned short      takeupMaxTension;	        /* takeup sensor max tension A/D counts */
    unsigned short      takeupMinTension;	        /* takeup sensor min tension A/D counts */ 
}Pr_Config;                                                              
#pragma pack( push,1 )
#pragma pack( pop )
