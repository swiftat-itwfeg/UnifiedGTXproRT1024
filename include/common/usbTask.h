...
/* prototypes */
BaseType_t createUsbTask( SubClass_t subClass, QueueHandle_t prSendQueue, QueueHandle_t wrSendQueue );
void USB_OTG1_IRQHandler( void );
SubClass_t getUSBDeviceSubClass( void );
void USB_DeviceClockInit( void );
void USB_DeviceIsrEnable( void );
void usbTask( void *parameter );
void setTotalLabelSize( unsigned long size );
unsigned long getPacketTransferTotal( void );
TaskHandle_t getUsbHandle( void );
...
/******************************************************************************/
usb_status_t USB_DeviceCdcVcomInit( void );
usb_status_t USB_DeviceCdcVcomCallback( class_handle_t handle, uint32_t event, void *param );
usb_status_t USB_DeviceCdcVcomSetConfigure( class_handle_t handle, uint8_t configure );
usb_status_t USB_DeviceCdcVcomRecvNext(class_handle_t handle);
/******************************************************************************/
/******************************************************************************/
#endif 
