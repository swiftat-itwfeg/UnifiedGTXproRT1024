...
#define cutter_task_PRIORITY ( configMAX_PRIORITIES - 1 )
...
#define AC_DOOR_OPEN                            0x8000
#define AC_SADDLE_OPEN                          0x4000
#define AC_DOOR_OPEN_SADDLE_CLOSED              0x8008
#define AC_SADDLE_OPEN_DOOR_CLOSED              0x4008
#define AC_INTERLOCKS_CLOSED                    0x3008
#define AC_INTERLOCKS_OPEN                      0x0008

#define AC_INTERLOCKS_CLOSED_BNH                0x3000
#define AC_INTERLOCKS_OPEN_BNH                  0x0000
#define AC_DOOR_OPEN_SADDLE_CLOSED_BNH          0x8000
#define AC_SADDLE_OPEN_DOOR_CLOSED_BNH          0x4000
#define AC_INTERLOCKS_CLOSED_BNH                0x3000
#define AC_INTERLOCKS_OPEN_BNH                  0x0000

/* version string sizes */
#define MAX_PRODUCT_NAME_SIZE                   19
#define MAX_FIRMWARE_NUM_SIZE                   12
#define MAX_FIRMWARE_ISSUE_SIZE                 16
...
#else
#define PAPER_CUT_MSG_SIZE              0x33313030          /* 13 */
#endif
...
#define PAPER_CUT_RX_STEPS_MSG_SIZE_    18
#define READ_PROFILE_RX_MSG_SIZE_       13 
#define DEFAULT_MSG_RX_SIZE_            18
    
//new v2 cutter board firmware
#define READ_VERSION0_RX_MSG_SIZE_      34 
#define READ_VERSION1_RX_MSG_SIZE_      30 
#define READ_VERSION2_RX_MSG_SIZE_      33 
#define READ_VERSION3_RX_MSG_SIZE_      29 
#define READ_VERSION4_RX_MSG_SIZE_      26 

//old v1 cutter board firmware
//#define READ_VERSION0_RX_MSG_SIZE_      37
//#define READ_VERSION1_RX_MSG_SIZE_      30
//#define READ_VERSION2_RX_MSG_SIZE_      34
//#define READ_VERSION3_RX_MSG_SIZE_      29
//#define READ_VERSION4_RX_MSG_SIZE_      26                                                            
...
{    
    ...
    AC_ERROR_,
    AC_TX_DEVICE_STATUS_,
    AC_RX_DEVICE_STATUS_
}ACTSTATES;
...
void responseTimeout( TimerHandle_t respTimer_ );
